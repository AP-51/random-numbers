...
\begin{figure}[h]
\centering
\includegraphics[width=\columnwidth]{./plots/cdf_plot_py.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=\columnwidth]{./plots/gau_cdf_plot_py.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=\columnwidth]{./plots/pdf_plot_py.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=\columnwidth]{./plots/ln_cdf_plot_py.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=\columnwidth]{./plots/tri_cdf_plot_py.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=\columnwidth]{./plots/tri_pdf_plot_py.png}
    \caption{The PDF of $T=U_1+U_2$}
    \label{fig:T_pdf}
\end{figure}
\end{enumerate}
